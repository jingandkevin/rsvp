...
class RSVPForm(Form):
    ...
    attending = SelectField(choices=[('1', 'I plan to attend'), ('0', 'I regretfully decline')], validators=[DataRequired()])
    plusone = SelectField(choices=[('1', 'I am bringing a +1'), ('0', 'I am not bringing anyone')], validators=[DataRequired()])
